...
function HumanPlayer(board) {
    ...
    function handleTurnTaken(event) {
        // console.log("wybór")
        event.target.innerText = 'X';                                                                               //dodajemy X - potem zmien na obraz
        board.positions
...
function ComputerPlayer(board) {
    this.takeTurn = function() {
        ...
        availablePositions[move].innerText = 'O';                                                                    //komputer dodaje O - potem zmienic na obraz
    }
}